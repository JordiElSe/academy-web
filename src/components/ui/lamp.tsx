    ...
    >
      <div className="relative flex w-full flex-1 items-center justify-center isolate z-0 ">
        <motion.div
          ...
          className="absolute inset-auto top-0 right-1/2 h-56 w-[20%] overflow-visible bg-gradient-conic from-bg-300 via-transparent to-transparent text-white [--conic-position:from_70deg_at_center_top]"
        >
        ...
        <motion.div
          ...
          className="absolute inset-auto top-0 left-1/2 h-56 w-[20%] bg-gradient-conic from-transparent via-transparent to-bg-300 text-white [--conic-position:from_290deg_at_center_top]"
        >
