...
export default function OurCourses() {
  return (
    <div className="flex flex-col px-3 sm:px-6 md:px-8 pt-6">
      <div className="space-y-3 text-center">
        <h3>Path to Catalan mastery</h3>
        <h2>Our Courses</h2>
      </div>
      <p className="text-lg text-center px-16 pt-10">
      ...
      <p className="pt-10 text-center text-xl">
        TODO: Add rodmap stop pic or animation and show its contents.
      </p>
      {/* 
      ...
      <div className="py-10 lg:py-20 space-y-10 sm:space-y-20">
        <div>
          <h2 className="text-2xl sm:text-3xl font-bold mb-6 sm:mb-10 text-center">
            For Beginners
          </h2>
          <div className="flex flex-col lg:flex-row gap-6 sm:gap-10 justify-center items-center max-w-7xl mx-auto">
            {Acourses.map((course) => (
...
const Acourses = [
  {
    ...
    description:
      "This course will teach you the basics of Catalan starting from scratch. You will learn the alphabet, numbers, and basic vocabulary, as well as the basics of pronounciation. After completing this course, you will be able to understand and use familiar everyday expressions and basic phrases.",
    hours: 20,
    podcasts: 15,
    exercises: 30,
    tests: 5,
