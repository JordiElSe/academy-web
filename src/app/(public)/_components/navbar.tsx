...
const Navbar: React.FC = () => {
  return (
    <motion.nav
      ...
      className="hidden md:block max-w-7xl  fixed top-4  mx-auto inset-x-0 z-50 w-[95%] lg:w-full"
      ...
      <div className="w-full">
        <div className="w-full flex relative justify-between px-4 py-3 rounded-lg transition duration-200 bg-neutral-100 dark:bg-neutral-900 mx-auto">
          <div className="flex flex-row gap-2 items-center">
            <a
              className="font-normal flex space-x-2 text-sm lg:mr-4 text-black px-2 py-1  relative z-20 whitespace-nowrap"
              href="/"
            >
              <svg
                width="35"
              ...
              <span className="hidden lg:block text-black dark:text-white font-bold">
                Sounds of Catalan
              </span>
            </a>
            <div className="flex items-center lg:gap-1.5">
              <a
                className="flex items-center justify-center text-sm leading-[110%] px-3 py-2 lg:px-4 lg:py-2 rounded-md hover:bg-neutral-200 dark:hover:bg-neutral-800 hover:text-black/80 dark:hover:text-white/80 text-black dark:text-white hover:shadow-[0px_1px_0px_0px_#FFFFFF20_inset] transition duration-200"
                href="/about"
              >
                About
              </a>
          ...
          <div className="flex justify-end w-full space-x-2 items-center">
            <div className="transform transition duration-350 hover:scale-115 text-xl cursor-pointer flex justify-center items-center">
              <ThemeSwitch />
            </div>
            <LoginButton mode="modal" asChild>
              <a
                className="group hover:-translate-y-0.5 active:scale-[0.98] relative z-10 bg-transparent hover:border-secondary hover:bg-secondary/50 border border-transparent text-black dark:text-white text-sm md:text-sm transition font-medium duration-200 rounded-md px-3 py-2 lg:px-4 lg:py-2 flex items-center justify-center"
                href="/register"
              >
                Log In
              </a>
